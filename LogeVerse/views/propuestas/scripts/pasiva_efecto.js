export function pasiva_efecto() {
    const availableContainer = document.getElementById('pasiva_avaliable_efects');
    const selectedContainer = document.getElementById('pasiva_selected_efects');
    ...
    document.querySelectorAll('.pasiva_efecto').forEach(div => {
    ...
    const checkbox = document.querySelector("#checkbox_pasiva_efectos input[type='checkbox']");
    const efectSection = document.getElementById("pasiva_efectos_select");

    // Aplicar estado inicial
    if (checkbox.checked) {
        efectSection.removeAttribute("hidden");
        efectSection.classList.add("pasiva_efectos_select_style");
    } else {
        efectSection.setAttribute("hidden", true);
        efectSection.classList.remove("pasiva_efectos_select_style");
    }
    ...
    document.removeEventListener("DOMContentLoaded", pasiva_efecto);
}